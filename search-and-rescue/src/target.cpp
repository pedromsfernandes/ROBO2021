...
CTarget::CTarget() : m_pcWheels(NULL),
                     m_pcProximity(NULL),
                     m_cAlpha(10.0f),
                     m_fDelta(0.5f),
                     m_pcLEDs(NULL),
...
void CTarget::Init(TConfigurationNode &t_node)
{
   /*
 ...
 */
REGISTER_CONTROLLER(CTarget, "search_and_rescue_target_controller")
